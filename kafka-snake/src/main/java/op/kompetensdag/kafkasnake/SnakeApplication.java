...
public class SnakeApplication {
    ...
    public static void main(String[] args) {
        ...
        gameInputBranched.branch(
                ...
                Branched.withConsumer(stream -> stream.mapValues(GameMovementKeyPressed::parse)
                        .to(GAME_MOVEMENT_COMMANDS, Produced.with(Serdes.String(), CustomSerdes.gameMovementKeyPressedValueSerde()))));

        gameInputBranched.branch(
                (k, v) -> GameAdministrationKeyPressed.parse(k, v) != null,
                Branched.withConsumer(stream -> stream.mapValues(GameAdministrationKeyPressed::parse)
                .to(GAME_ADMINISTRATION_COMMANDS, Produced.with(Serdes.String(), CustomSerdes.gameAdministrationKeyPressedValueSerde()))));
        ...
        gameInput.mapValues((k, v) -> GameMovementKeyPressed.parse(k, v)).to("Topic");
